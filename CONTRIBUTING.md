# Contributing to im-gegevensverstrekking-warmtetransitie

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-gegevensverstrekking-warmtetransitie. These guidelines are not strict rules.
...
The im-gegevensverstrekking-warmtetransitie team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-gegevensverstrekking-warmtetransitie technical leads
...
[issues]: https://github.com/Netbeheer-Nederland/im-gegevensverstrekking-warmtetransitie/issues/
[pulls]: https://github.com/Netbeheer-Nederland/im-gegevensverstrekking-warmtetransitie/pulls/
